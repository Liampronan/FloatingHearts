...
class ViewController: UIViewController {
    ...
    @objc func showTheLove(gesture: UITapGestureRecognizer?) {
        ...
        let fountainX = view.bounds.width / 2.0 // HeartAttributes.heartSize / 2.0 + 20
        let fountainY = view.bounds.height / 1.5 // view.bounds.height- HeartAttributes.heartSize / 2.0 - 10
